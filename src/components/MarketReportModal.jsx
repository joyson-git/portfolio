...
export default function MarketReportModal({ onDone, autoAdvance = false }) {
      ...
      >
        ...
        <div className="np-loader-top-bar">
          ...
          <div className="np-loader-top-right">
            <button
              ...
              title="Return to Joyson Pinto's Portfolio [ESC]"
            >
              <span>✕ Close Dossier · Return to Portfolio ➔</span>
            </button>
          </div>
        </div>
        ...
        <div className="np-broadsheet-wrapper" style={{ position: 'relative', zIndex: 2 }}>
              ...
              <div className="np-ear-box__content">
                ...
                <div className="np-ear-box__text font-mono">
                  <strong style={{ fontSize: '0.74rem', display: 'block', letterSpacing: '0.02em', color: 'var(--np-ink)' }}>
                    ~680,000+ REDUNDANCIES
                  </strong>
                  <p style={{ margin: '2px 0 0', fontSize: '0.66rem', color: 'var(--np-ink-body)', lineHeight: 1.25 }}>
          ...
          <div className="np-dateline-bar font-mono">
            <span style={{ whiteSpace: 'nowrap' }}>VOL. I NO. 142 · PAGE 1</span>
            <span style={{ textAlign: 'center' }}>BANGALORE · SPECIAL FIVE-YEAR WIRE DOSSIER</span>
            <span style={{ whiteSpace: 'nowrap' }}>EST. 1890 · LATE CITY EDITION</span>
            <span style={{ whiteSpace: 'nowrap' }}>PRICE: TWO PENCE</span>
          </div>
          <hr className="np-rule-double" />
          ...
          <h2
            ...
            style={{ margin: '0.6rem auto 0.8rem', fontSize: 'clamp(2.2rem, 5vw, 4.2rem)', maxWidth: '1200px', textWrap: 'balance' }}
          >
